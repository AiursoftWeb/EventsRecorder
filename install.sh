...
app_name="eventsRecorder"
repo_path="https://gitlab.aiursoft.com/aiursoft/eventsRecorder"
proj_path="src/Aiursoft.EventsRecorder/Aiursoft.EventsRecorder.csproj"
