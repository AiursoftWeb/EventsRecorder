...
using Aiursoft.EventsRecorder.Models.SystemViewModels;
...
[Authorize]
[LimitPerMin]
public class SystemController(ILogger<SystemController> logger, EventsRecorderDbContext dbContext) : Controller
{
